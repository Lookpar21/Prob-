...
// counts = จำนวนไพ่ที่เหลือในขอน (เริ่ม A..K = 32 ใบ)
...
btnReset.onclick=()=>{
  ...
  renderAll(); nextProbDiv.innerHTML=""; permsOutDiv.innerHTML=""; simResultsDiv.innerHTML=""; recBox.className="recommend neutral"; recBox.innerHTML='<p class="rec-title">ยังไม่มีผลจำลอง</p><p class="rec-sub">กด “เริ่มจำลอง” ก่อน แล้วระบบจะแนะนำให้อัตโนมัติ</p>'; evTable.innerHTML="";
};
...
// =========================
// 4) Monte Carlo of next hand (Baccarat rules)
// =========================
